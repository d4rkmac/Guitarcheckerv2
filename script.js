Parse.initialize(
    "FxQjaPpu9DOZ2wHxI7VhN4Bw4Oe7SBJ6Ts6fzEzV",
    "zOt8x0095HCTYgVxdjSu52F3O7BJVrS6hzVT4Xjs"
);
Parse.serverURL = 'https://pg-app-gos7xdqeqg03ux0licrjdkcbxfa0zs.scalabl.cloud/1/';

const URL = "https://teachablemachine.withgoogle.com/models/qHROzNkYH/";
...
async function predict(input) {
    ...
    if (bestClass == "A" || bestClass == "B" || bestClass == "C" || bestClass == "D" || bestClass == "E" || bestClass == "F" || bestClass == "G") {
